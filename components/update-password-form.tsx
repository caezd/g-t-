      ...
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Nous préparons votre session pour vous permettre de définir votre
              mot de passe.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-red-500 mb-2">
              {sessionError ?? "Le lien est invalide ou a expiré."}
            </p>
            <p className="text-sm text-muted-foreground">
              Fermez cette page et demandez une nouvelle invitation à
              l&apos;administrateur.
            </p>
          </CardContent>
        </Card>
