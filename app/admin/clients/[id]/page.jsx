        ...
        <main className="p-8">
            <div className="lg:flex lg:items-center lg:justify-between">
                    ...
                    <nav className="flex">
                        <ol className="flex items-center space-x-4">
                            ...
                            <li className="flex items-center">
                                ...
                                <a
                                    href="#"
                                    className="ml-4 font-medium text-zinc-600 dark:text-zinc-400 text-sm hover:text-zinc-900"
                                >
                                    {client?.name}
                                </a>
                            </li>
                    ...
                    <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                        ...
                        <div className="mt-2 flex items-center text-sm text-zinc-600 dark:text-zinc-400">
                            <svg
                                ...
                                data-slot="icon"
                                aria-hidden="true"
                                className="mr-1.5 size-5 shrink-0 text-zinc-500"
                            >
                                <path
                ...
                <div className="mt-5 flex lg:mt-0 lg:ml-4">
                    ...
                    <el-dropdown className="relative ml-3 sm:hidden">
                        ...
                        <el-menu
                            anchor="bottom start"
                            popover
                            className="-mr-1 w-24 origin-top-right rounded-md bg-zinc-800 py-1 outline -outline-offset-1 outline-white/10 transition transition-discrete [--anchor-gap:--spacing(2)] data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                        >
                            <a
                                href="#"
                                className="block px-4 py-2 text-sm text-zinc-300 focus:bg-white/5 focus:outline-hidden"
                            >
                                Edit
                            </a>
                            <a
